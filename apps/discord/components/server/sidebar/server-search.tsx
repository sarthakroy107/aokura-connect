  ...
  return (
    <>
      <button
        ...
        className="flex justify-between w-[205px] p-1 px-1.5 rounded-[3px] shadow-sm shadow-black/10 text-sm bg-discord m-1.5"
      >
        <div className="flex gap-x-2 items-center">
          <LucideSearch size="14" />
          <p>Search</p>
        </div>
        <kbd className="bg-discord_darkest text-white/20 text-xs p-[2px] rounded-[2px]">
          ⌘+k
        </kbd>
      </button>
      <CommandDialog open={open} onOpenChange={setOpen}>
        <Command className="bg-discord">
          <CommandInput
            ...
            className=""
            placeholder="Search member and profile in server"
          />

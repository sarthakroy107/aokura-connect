...
export default function DirectMessasgeSidebar() {
  return (
    <div className="min-w-[220px] max-w-[220px] h-screen overflow-auto bg-[rgb(40,43,48)] text-white space-y-1 p-1">
      ...
      <DirectMessageProfileComp
        id="4"
        name="Megumin"
        avatar="https://thicc-af.mywaifulist.moe/waifus/roxy-migurdia-mushoku-tensei/t3fPALRL6X40EHwMOBaQrEBDNW8PjfUkDBOBGoFS.png?class=thumbnail"
        status={true}
      />
      <DirectMessageProfileComp
        id="5"
...
function DirectMessageProfileComp({
  ...
  return (
    <Link href={`/me/${id}`} className="w-full flex p-1 px-1.5 hover:bg-white/10 rounded-sm cursor-pointer space-x-1.5 items-center">
      <Image
        src={avatar}
        alt="avatar"
        width={40}

...
type TResetPasswordEmail = {
  name: string;
  resetPasswordLink: string;
};

export const ResetPasswordEmail: React.FC<Readonly<TResetPasswordEmail>> = ({
  name,
  resetPasswordLink,
}) => {
  return (
    <Html>
      <Head />
      <Preview>Reset password, from Aokura Connect</Preview>
      <Tailwind>
        <Body className="bg-slate-200 text-gray-600 font-sans">
          ...
          <Section className="w-[480px] mt-5 mb-3 ">
            ...
            <Text className="text-center text-base font-medium text-zinc-500">
              Delevoped & maintained by{" "}
              <span className="text-black/75 font-semibold mb-8">
                Sarthak Roy
              </span>
            </Text>
          </Section>
